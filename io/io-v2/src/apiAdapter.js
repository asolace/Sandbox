...
class Lead extends API {
  ...
  static get () {
    return super.request(Lead.URL, 'GET')
  }
  static create (params) {
    return super.request(Lead.URL, 'POST', params)
  }
  static delete (id) {
    return super.request(`${Lead.URL}/${id}`, 'DELETE')
  }
  static update (id, params) {
    return super.request(`${Lead.URL}/${id}`, 'PUT', params)
  }
